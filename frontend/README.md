# InvenTreeBambuLabMachines- Frontend Code

This directory contains the frontend code for the InvenTreeBambuLabMachines plugin.
...
This will compile the frontend into the `../inventreebambulabmachines/static` directory (ready for distribution).
