 ...
 */
function InvenTreeBambuLabMachinesDashboardItem({
    context
}: {
    ...
    const pluginName : string = "InvenTreeBambuLabMachines";
...
//  component
export function renderInvenTreeBambuLabMachinesDashboardItem(context: InvenTreePluginContext) {
    checkPluginVersion(context);
    return <InvenTreeBambuLabMachinesDashboardItem context={context} />;
}
